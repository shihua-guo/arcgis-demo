...
A basemap layer is a layer that provides geographic context to the map or scene. A web scene does not always contain a basemap. The following is a list of possible basemap layer types.
